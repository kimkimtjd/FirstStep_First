    ...
    return (
        <MentorText>
           ...
           {/* 결제예정금액 */}
            ...
            <Devinder />
             ...
             <PayBox style={{ paddingBottom:"32px"}}>
                ...
                <PayTitle style={{ marginTop:"16px"}}>
                    ...
                    :
                    <span style={{ color:"#00C563" }} onClick={()=> navigate(`/Class/choice/bank/${data.id}`)}>은행을 선택해주세요</span>
                    }
                </PayTitle>
            ...
            {/* 버튼 */}
            <ProfileBtn onClick={() => navigate(`/Class/end/${data.id}`)}> 
                확인
            </ProfileBtn>
        </MentorText >
    );
